...
export const riskDecisionSchema = z.object({
  ...
  projectedLossAmount: z.number().optional(),
  projectedRewardAmount: z.number().optional(),
  ...
  fundedAccount: z
    .object({
      ...
      drawdownMode: z.enum(['STATIC', 'EOD_TRAILING']),
      profitTargetAmount: z.number(),
      remainingToTargetAmount: z.number(),
      targetProgressPct: z.number(),
      remainingToTargetPct: z.number(),
      drawdownAnchorEquity: z.number(),
      lossLevel: z.number(),
      drawdownBufferAmount: z.number(),
...
export const riskCheckBodySchema = z.object({
  ...
  account: z.object({
    ...
    highestEodEquity: z.number().positive().optional(),
    lossLevel: z.number().positive().optional(),
  ...
  .object({
    ...
    fundedAccount: z
      .object({
        ...
        drawdownMode: z.enum(['STATIC', 'EOD_TRAILING']).optional(),
...
export const signalMonitorSettingsPatchSchema = z
  .object({
    ...
    minProjectedReturnDollars: z.number().min(0).optional(),
