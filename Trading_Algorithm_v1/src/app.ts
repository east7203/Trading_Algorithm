...
const resolveContinuousTrainingConfig = (
  ...
  const defaults: ContinuousTrainingConfig = {
    ...
    trainingOptions: {
      timezone: process.env.CONTINUOUS_TRAINING_TIMEZONE ?? 'America/Chicago',
      sessionStartHour: parseIntEnv('CONTINUOUS_TRAINING_SESSION_START_HOUR', 7, 0, 23),
      sessionStartMinute: parseIntEnv('CONTINUOUS_TRAINING_SESSION_START_MINUTE', 0, 0, 59),
      sessionEndHour: parseIntEnv('CONTINUOUS_TRAINING_SESSION_END_HOUR', 13, 0, 23),
      sessionEndMinute: parseIntEnv('CONTINUOUS_TRAINING_SESSION_END_MINUTE', 0, 0, 59),
...
const resolveSignalMonitorConfig = (
  ...
  const defaults: SignalMonitorConfigInput = {
    ...
    timezone: process.env.SIGNAL_MONITOR_TIMEZONE ?? 'America/Chicago',
    sessionStartHour: parseIntEnv('SIGNAL_MONITOR_SESSION_START_HOUR', 7, 0, 23),
    sessionStartMinute: parseIntEnv('SIGNAL_MONITOR_SESSION_START_MINUTE', 0, 0, 59),
