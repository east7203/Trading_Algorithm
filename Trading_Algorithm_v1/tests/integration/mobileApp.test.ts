...
describe('mobile app endpoints', () => {
  it('serves health and mobile app shell', async () => {
    ...
    expect(mobile.body).toContain('What Works');
    expect(mobile.body).toContain('Is Learning Working?');
    expect(mobile.body).toContain('Improvement Check');
    expect(mobile.body).toContain('Model Choice');
    expect(mobile.body).toContain('Accuracy');
    expect(mobile.body).toContain('Refresh Check');
    expect(mobile.body).toContain('Open IBKR Recovery');
    expect(mobile.body).toContain('Market Lean');
    expect(mobile.body).toContain('Best Setups');
    expect(mobile.body).toContain('Use Caution');
    expect(mobile.body).toContain('Recent Paper Choices');
    expect(mobile.body).toContain('System Status');
    expect(mobile.body).toContain('Pull to refresh');
    expect(mobile.body).toContain('Model Training');
    ...
    expect(mobile.body).toContain('Grouped by action: ready, wait, or avoid.');
    ...
    expect(mobile.body).toContain('Latest Login Evidence');
